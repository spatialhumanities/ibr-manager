...
public class Triangle extends Plane implements GeoFeature {
    ...
    public double visibleRandom(double tol, String path) throws IOException{
        ArrayList<Point> randomPoints = Visibility.randomPoints(this, 500);
              
        return Visibility.visible(randomPoints, tol, path);
    }
